...
<h3 style="margin-top: 1.5rem;">Change username</h3>
<form method="POST" action="<?= e(url_for('profile_change_username')) ?>">
    <div class="form-group">
        <label>Username</label>
        <input type="text" name="new_username" value="<?= e($me['username']) ?>" required>
    </div>
